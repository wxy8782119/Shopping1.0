...
<body>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pageBean.currentPage!=1 }">
				<li>
					<a href="${pageContext.request.contextPath }/product?method=productList&cid=${cid }&currentPage=1" aria-label="Previous">
			...
			<c:if test="${pageBean.currentPage!=pageBean.totalPage }">
				...
				<li>
					<a href="${pageContext.request.contextPath }/product?method=productList&cid=${cid }&currentPage=${pageBean.totalPage}" aria-label="Next"> 
